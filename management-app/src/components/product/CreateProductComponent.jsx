    ...
    return (
      <div className="d-flex align-items-center justify-content-between px-4 py-3"
        ...
        <div className="d-flex align-items-center gap-2">
          <button type="button" className="btn btn-light border" onClick={() => this.props.history.goBack()}>
            <i className="bi bi-arrow-left me-1" /> Back
          </button>
          <h5 className="m-0">{isAdd ? 'Add Product' : 'Update Product'}</h5>
        </div>
        <div className="d-flex gap-2">
          <button type="button" className="btn btn-outline-secondary" onClick={this.cancel}>Cancel</button>
          <button type="submit" form="turnForm" className="btn btn-primary" disabled={this.state.loading}>
            {this.state.loading ? (<><i className="bi bi-arrow-repeat me-1" /> Saving…</>) : (<><i className="bi bi-check2 me-1" /> Save</>)}
          </button>
        </div>
      </div>
    );
          ...
          <div className="card-body px-4 px-md-5 py-4">
            ...
            <form id="turnForm" onSubmit={this.saveOrUpdateProduct}>
              ...
              <div className="d-flex justify-content-end gap-2">
                ...
                <button type="submit" className="btn btn-primary" disabled={s.loading}>
