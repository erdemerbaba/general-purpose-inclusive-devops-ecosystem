          ...
          >
            ...
            <div className="d-flex align-items-center justify-content-between px-4 py-3" style={{ borderBottom: '1px solid #eef0f3' }}>
              <div className="d-flex align-items-center gap-2">
                <button className="btn btn-light border" onClick={() => this.props.history.goBack()} style={{ display: 'block', paddingBottom: '30px' }}>
                  <i className="bi bi-arrow-left me-1" /> Back
                </button>
                <h5 className="m-0" style={{ display: 'block', paddingLeft: '350px' }}>Employee Details</h5>
              </div>
              <button className="btn btn-outline-primary" onClick={() => this.props.history.push(`/add-user/${this.state.id}`)} style={{ display: 'block', paddingBottom: '30px' }}> 
                  ...
                  <>
                    ...
                    <div className="d-flex justify-content-center gap-2 pt-2">
                      <button
                        ...
                        style={{ display: 'block', paddingBottom: '30px', marginRight: '8px' }}
                      >
                        Close
                      </button>
                      <button
